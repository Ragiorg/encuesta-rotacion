...
import QuestionarieForm from '@/components/ui/questionarie'
...
export default function EncuestaPage() {
  ...
  useEffect(() => {
    const checkSession = async () => {
      ...
      // fetch the user survey status from the session
    ...
    <div className="min-h-screen py-8">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 mb-8">
        ...
        >
          ...
          {survey?.isCompleted ? (
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Completa la encuesta a través de nuestro formulario dinámico. Tus respuestas son completamente confidenciales.
          </p>
          )}
      ...
      { !survey?.isCompleted && survey?.questions ? (
        ...
        <div className="text-center">
          <h2 className="text-2xl font-semibold">Gracias por completar la encuesta</h2>
          <p className="text-sm text-muted-foreground">Tus respuestas han sido guardadas.</p>
        </div>
      )}
      {/* Support Info */}
